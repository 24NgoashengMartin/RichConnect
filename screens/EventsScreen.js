...
export default function EventsScreen({ navigation }) {
  ...
  const defaultEvents = [
    { id: 'e1', title: 'Career Fair 2026', date: '2026-10-15', location: 'Richfield Pretoria', type: 'Career Fair', description: 'Meet top employers from IT, Finance and Engineering sectors.' },
    { id: 'e2', title: 'CV Writing Workshop', date: '2026-09-25', location: 'Online', type: 'Workshop', description: 'Learn how to write a winning CV with our career coaches.' },
  ...
  const getTypeColor = (type) => {
    if (type === 'Career Fair') return '#003399';
    if (type === 'Workshop') return '#CC0000';
    return '#00aa44';
  };
        ...
        {allEvents.map(event => (
          <View key={event.id} style={styles.eventCard}>
            ...
            <TouchableOpacity style={styles.registerBtn}>
              <Text style={styles.registerBtnText}>Register Interest</Text>
            </TouchableOpacity>
          </View>
        ))}
      </ScrollView>
...
const styles = StyleSheet.create({
  ...
  content: { padding: 16 },
  eventCard: { backgroundColor: '#fff', borderRadius: 12, padding: 16, marginBottom: 16, elevation: 2 },
